...
public class ContractController {
    ...
    public ResponseDto invite(@RequestParam Long userId,
    ...
    public ResponseDto acceptInvitation(@RequestParam Long userId,
    ...
    public ResponseDto rejectInvitation(@RequestParam Long userId,
                                        @RequestParam Long invitationId) {
